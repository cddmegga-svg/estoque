...
import { SuppliersPage } from '@/legacy/pages/SuppliersPage';
import { FinancialPage } from '@/legacy/pages/FinancialPage';
import { PurchaseRequestsPage } from '@/legacy/pages/PurchaseRequestsPage';
import { SalesPage } from '@/legacy/pages/SalesPage';
import { ConferencePage } from '@/legacy/pages/ConferencePage';
import { LogisticsPage } from '@/legacy/pages/LogisticsPage';
import { POSPage } from '@/legacy/pages/POSPage';
import { CustomersPage } from '@/legacy/pages/CustomersPage';
...
function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'backups':
        return <PlaceholderPage title="Gest�o de Backups Locais" />;
      default:
        return <DashboardPage user={user} onNavigate={handleNavigate} />;
    }
  };
